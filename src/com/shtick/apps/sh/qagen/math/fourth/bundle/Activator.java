package com.shtick.apps.sh.qagen.math.fourth.bundle;
...
import com.shtick.apps.sh.qagen.math.fourth.FourthGradeMathQuestionGenerator;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context){
		...
		subjectRegistration=context.registerService(SubjectQuestionGenerator.class.getName(), new FourthGradeMathQuestionGenerator(),new Hashtable<String, String>());
    }
